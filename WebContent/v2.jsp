			...
			<form class="form-inline" method="POST" onsubmit="storeValues(this)">
				...
				<div class="col-md-12">
					<div class="col-md-3">
						<input type="radio" name="whose" value="customer"
							checked="checked" ${mybean.field4[0]} /> Customer
					</div>
					<div class="col-md-3">
						...
						<div class="col-md-12">
							<div class="col-md-3">
								<input type="radio" id="yes" name="r61" value="61yes"
									checked="checked" ${mybean.field16[0]} checked="checked" />Yes
							</div>
							<div class="col-md-3">
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-12">
						...
						<div class="col-md-3">
							<input class="6checkbox" type="checkbox" name="informationWhen"
								value="openAccount" ${mybean.field27[0]} /> <label for="income">Open
								an account</label>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-3">
							<input class="6checkbox" type="checkbox" name="informationWhen"
								value="useCard" ${mybean.field27[3]} /> <label for="income">Use
								credit/debit card</label>
						</div>

						<div class="col-md-3">
							<input class="6checkbox" type="checkbox" name="informationWhen"
								value="payBill" ${mybean.field27[4]} /> <label for="income">Pay
								your bills</label>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<input class="6checkbox" type="checkbox" name="informationWhen"
								...
								${mybean.field27[17]} /> <label for="income">Enter into
					...
					<div class="col-md-12">
						...
						<div class="col-md-3">
							<input class="6checkbox" type="checkbox" name="informationWhen"
								value="applyLease" ${mybean.field27[22]} /> <label for="income">Apply
								for a lease</label>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-3">
							<input class="6checkbox" type="checkbox" name="informationWhen"
								value="applyLoan" ${mybean.field27[31]} /> <label for="income">Apply
								for a loan</label>
