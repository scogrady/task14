		...
		<div class="row">
			<form class="form-inline" method="POST" onsubmit="storeValues(this)">
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-12">
						<div class="col-md-3">
							<input type="radio" id="yes" name="r21" value="21yes" checked="checked"
								${mybean.field7[0]} />Yes
						</div>
						<div class="col-md-3">
					...
					<div class="col-md-12">
						<div class="col-md-3">
							<input type="radio" id="yes" name="r31" value="31yes" checked="checked"
								${mybean.field9[0]} />Yes
						</div>
						<div class="col-md-3">
					...
					<div class="col-md-12">
						<div class="col-md-3">
							<input type="radio" id="yes" name="r71" value="71yes" checked="checked"
